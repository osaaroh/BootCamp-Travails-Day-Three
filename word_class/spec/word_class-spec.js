const wrdCheck = require("../word_class");
...
describe("words()", function() {
    ...
    it("counts one word", function() {
        ...
        expect(wrdCheck.words("word")).toEqual(expectedCounts);
    ...
    it("counts one of each", function() {
        ...
        expect(wrdCheck.words("one of each")).toEqual(expectedCounts);
    ...
    it("counts multiple occurrences", function() {
        ...
        expect(wrdCheck.words("one fish two fish red fish blue fish")).toEqual(expectedCounts);
    ...
    it("includes punctuation", function() {
        ...
        expect(wrdCheck.words("car : carpet as java : javascript!!&@$%^&")).toEqual(expectedCounts);
    ...
    it("includes numbers", function() {
        ...
        expect(wrdCheck.words("testing 1 2 testing")).toEqual(expectedCounts);
    ...
    it("respects case", function() {
        ...
        expect(wrdCheck.words("go Go GO")).toEqual(expectedCounts);
    ...
    it("counts properly international characters", function() {
        ...
        expect(wrdCheck.words("¡Hola! ¿Qué tal? Привет!")).toEqual(expectedCounts);
    ...
    it("counts tabs", function() {
        ...
        expect(wrdCheck.words("hello\tworld")).toEqual(expectedCounts);
    ...
    it("handles properties that exist on Object's prototype", function() {
        ...
        expect(wrdCheck.words("reserved words like prototype and toString ok?")).toEqual(expectedCounts);
